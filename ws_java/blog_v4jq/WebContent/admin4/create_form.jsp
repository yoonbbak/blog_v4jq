 ...
 <DIV class='container'>
  ...
  <DIV class='content'>
   ...
   <FORM name='frm' method='POST' action='./create_proc.jsp'>
    <fieldset class='fieldset_no_line' style="width: 80%; margin: 0px auto;"> 
     <ul>
      <li class='li_none'>
      ...
      <li class='li_none'>
       ...
       <input type='email' name='email' id='email' required="required" value='testcell2010@gmail.com'
        style='width: 20%;'> [<A href='javascript: email_duplicate();'>이메일 중복 검사</A>]
      </li>
      <li class='li_none'>
      ...
      <li class='li_none'>
       <label class='label_basic' for='tel'>전화번호</label>
       <input type='text' name='tel' id='tel' value='010-1111-1111'> 예) 010-1111-1111
      </li>
      <li class='li_none'>
       <label class='label_basic' for='zipcode'>우편번호</label>
       <input type='text' name='zipcode' id='zipcode' value='01111' style="width: 10%">
       [<A href='javascript: DaumPostcode();'>우편번호 찾기</A>]
      </li>
      <li class='li_none'>
       <label class='label_basic' for='address1'>주소</label>
       <input type='text' name='address1' id='address1' value='' style="width: 40%;">
      </li>
      <li class='li_none'>
       <label class='label_basic' for='address2'>상세주소</label>
       <input type='text' name='address2' id='address2' value='' style="width: 40%">
      </li>
      
      <li class='li_none' style="padding-left: 120px;">
        <!-- ----------------------------------- DAUM 우편번호 API 시작 ---------------------------------- -->
            ...
            function DaumPostcode() {
                ...
                new daum.Postcode({
                    oncomplete: function(data) {
                        ...
                        // ----------수정한 곳 ----------
                        // $('#address2').focus();
                        document.getElementById('address2').focus(); // getElementById: id를 가지고 태그를 찾는다
                    },
