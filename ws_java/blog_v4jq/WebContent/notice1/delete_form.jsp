    ...
    <DIV class='content'>
      ...
      <form name='frm' action='./delete_proc.jsp' method='POST'>
        ...
        <fieldset style='width: 70%; margin: 10px auto;'>
          <legend class="legend_basic">공지사항1 삭제</legend>
          <ul>
            <li class='li_none'>내용: <%=title%>
            </li>
            <li class='li_none'>성명: <%=rname%>
            </li>
            <li class='li_none'
              style="margin: 20px auto; text-align: center;"><span
              style='color: #FF0000; font-weight: bold;'>삭제를 진행하면
                복구 할 수 없습니다.</span> <br> 삭제하시겠습니까?</li>
          </ul>
        </fieldset>
