    ...
    <DIV class='content'>
      ...
      <form name='frm' action='./update_proc.jsp' method='POST'>
        ...
        <fieldset style='width: 70%; margin: 10px auto;'>
          <legend class="legend_basic">공지사항1 수정</legend>
          <ul>
            <li class="li_none"><label for="title"> 내용: </label> <input
              type="text" name="title" id="title" value="<%=title%>"
              style="width: 80%;"></li>
            <li class="li_none"><label for="name"> 성명: </label> <input
              type="text" name="name" id="name" value="<%=rname%>">
            </li>
          </ul>
        </fieldset>
