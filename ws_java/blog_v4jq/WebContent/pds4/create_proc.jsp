...
listFile = upload.getParameter("listFile"); 
...
%>
  ...
  <DIV class='bottom_menu' style='text-align: center;'>
    <button type='button' onclick="location.href='./create_form.jsp?categoryno=<%=categoryno %>&listFile=<%=listFile%>'">계속 등록</button>
    <button type='button' onclick="location.href='./<%=listFile %>?categoryno=<%=categoryno %>'">목록</button>
  </DIV>
